...
waterfall_sound = pygame.mixer.Sound('waterfallsound.wav')  # Added waterfall sound
flower_sound.set_volume(0.5)
jump.set_volume(0.5)
death.set_volume(0.9)
waterfall_sound.set_volume(0.3)  # Set waterfall sound volume
...
while running:
   ...
   while level2Flag:
      pygame.mixer.music.load('level2sound.mp3')  # Changed from level3sound.mp3
      pygame.mixer.music.play(-1)
      waterfall_sound.play(-1)  # Play waterfall sound on loop
      ...
      while running and level2Flag:
         ...
         if boppiRect.top > 720:
            ...
            if lives <= 0:  # if player dies
               level2Flag = False
               pygame.mixer.music.stop()
               waterfall_sound.stop()  # Stop waterfall sound
               deadFlag = True
               flowerRect_list = [
